<template>
  <div :class="['ai-questions-flow-container', className]" :style="style">
    <svg viewBox="0 0 1000 500" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(30, 100)">
        ...
        <text x="50" y="40" font-size="16" fill="#374151" font-weight="500">question 1</text>
      ...
      <g transform="translate(420, 175)">
        <!-- Loading dots above -->
        <g class="loading-dots" transform="translate(50, -30)">
          <circle class="loading-dot loading-dot-1" cx="0" cy="0" r="6" fill="#9ca3af"/>
          <circle class="loading-dot loading-dot-2" cx="24" cy="0" r="6" fill="#6b7280"/>
          <circle class="loading-dot loading-dot-3" cx="48" cy="0" r="6" fill="#4b5563"/>
        </g>
      ...
      <g transform="translate(700, 30)">
        ...
        <text x="42" y="35" font-size="14" fill="#374151" font-weight="500">question 2a</text>

        <!-- X icon -->
        <g transform="translate(230, 20)">
          <circle cx="0" cy="0" r="12" fill="#fef2f2"/>
          <path d="M-4,-4 L4,4 M4,-4 L-4,4" stroke="#ef4444" stroke-width="2" stroke-linecap="round"/>
        </g>
      ...
      <g transform="translate(700, 195)" class="selected-card">
        <rect x="0" y="0" width="260" height="150" rx="12" ry="12" fill="white" stroke="#22c55e" stroke-width="2" filter="url(#cardShadow)"/>

        <!-- Green dot and title -->
        <circle cx="25" cy="30" r="6" fill="#22c55e"/>
        <text x="42" y="35" font-size="14" fill="#374151" font-weight="500">question 2b</text>

        <!-- Checkmark icon -->
        <g transform="translate(230, 20)">
          <circle cx="0" cy="0" r="12" fill="#dcfce7"/>
          <path d="M-4,0 L-1,3 L4,-3" stroke="#22c55e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
        </g>
      ...
      <g transform="translate(700, 360)">
        ...
        <!-- Red dot and title -->
        <circle cx="25" cy="30" r="6" fill="#ef4444"/>
        <text x="42" y="35" font-size="14" fill="#374151" font-weight="500">question 2c</text>
...
<style scoped>
/* Container styles */
.ai-questions-flow-container {
  width: 100%;
  max-width: 1200px;
  margin: 0 auto;
}

.ai-questions-flow-container svg {
  width: 100%;
  height: auto;
  display: block;
}
...
.flow-line-input {
  ...
  animation: flowToCenter 0.8s linear infinite;
}
...
.flow-line-output {
  stroke-dasharray: 6 6;
  animation: flowFromCenter 1s linear infinite;
}
